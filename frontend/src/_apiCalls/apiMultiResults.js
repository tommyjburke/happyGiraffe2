...
export const getAllMultiResultByPupilId = async (payload) => {
   try {
      const response = await axiosInstance.post(
         '/api/multi-result/get-all-multi-results-by-pupil-id',
         payload
      )
      return response.data
   } catch (error) {
...
export const getAllMultiResultByAssignmentIdViaTeacherId = async () => {
   try {
      const response = await axiosInstance.post(
         '/api/multi-result/get-all-multi-results-by-teacher-id'
      )
      return response.data
   } catch (error) {
      return error.response.data
